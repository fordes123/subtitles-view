...
public class Launcher extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        scene.getStylesheets().add(getClass().getClassLoader().getResource(new ConfigRWUtil().ThemeInit()?"css/startStyle_Dark.css":"css/startStyle_Light.css").toExternalForm());
        stage.show();
    }
